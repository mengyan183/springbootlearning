...
public class RabbitMQConfig {
    ...
    public Queue finishAddChooseCourse() {
     ...
     */
    @Bean
    public Binding bindingQueueFinishAddCourse(@Qualifier(XC_LEARNING_FINISHADDCHOOSECOURSE) Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
     ...
     */
    @Bean
    public Binding bindingQueueAddCourse(@Qualifier(XC_LEARNING_ADDCHOOSECOURSE) Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
